...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../tmc_nios2.sopcinfo
...
# Design Name 
# setting SOPC_NAME is tmc_nios2
SOPC_NAME := tmc_nios2
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40800
SOPC_SYSID_FLAG += --sidp=0x40800
ELF_PATCH_FLAG  += --sidp 0x40800

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1458063708
SOPC_SYSID_FLAG += --timestamp=1458063708
ELF_PATCH_FLAG  += --timestamp 1458063708
