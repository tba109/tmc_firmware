...
module tmc_nios2_mm_interconnect_0 (
	...
	wire  [95:0] uart_0_s1_agent_rf_source_data;                                                     // uart_0_s1_agent:rf_source_data -> uart_0_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] uart_0_s1_agent_rsp_fifo_out_data;                                                  // uart_0_s1_agent_rsp_fifo:out_data -> uart_0_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> uart_0_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [94:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire         uart_0_s1_agent_rdata_fifo_src_valid;                                               // uart_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] uart_0_s1_agent_rdata_fifo_src_data;                                                // uart_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         uart_0_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_004:in_0_ready -> uart_0_s1_agent:rdata_fifo_src_ready
	...
	tmc_nios2_mm_interconnect_0_router_004 router_004 (
	...
	tmc_nios2_mm_interconnect_0_router_004 router_005 (
	...
	tmc_nios2_mm_interconnect_0_router_002 router_006 (
	...
	tmc_nios2_mm_interconnect_0_router_002 router_007 (
	...
	tmc_nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	tmc_nios2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
